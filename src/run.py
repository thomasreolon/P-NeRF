...
if __name__=='__main__':
    ...
    parser.add_argument("--preprocess", action="store_true", help="create dataset")
    parser.add_argument("--gen_video",  action="store_true", help="make final video")
    parser.add_argument("--scratch",  action="store_true", help="override previous progress")
